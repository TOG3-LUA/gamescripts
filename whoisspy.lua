...
frame.Position = UDim2.new(0.355, -21,0.297, 98)
frame.Size = UDim2.new(0, 339,0, 204)
spy.BackgroundTransparency = 1
spy.Position = UDim2.new(0.153, 0,0.694, 0)
spy.Size = UDim2.new(0, 233,0, 50)
spy.TextColor3 = Color3.fromRGB(255,255,255)
clue.BackgroundTransparency = 1
clue.Position = UDim2.new(0.156, 0,0.376, 0)
